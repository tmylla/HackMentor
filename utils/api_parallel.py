        ...
        try:
            async with aiohttp.ClientSession() as session:
                async with session.post(
                    url=request_url, headers=request_header, json=self.request_json, proxy='http://localhost:10809'
                ) as response:
...
# run script
# python utils/api_parallel.py --requests_filepath ./test_parallel.jsonl
...
if __name__ == "__main__":
    ...
    parser.add_argument("--request_url", default="https://open.aiproxy.xyz/v1/chat/completions")
    # parser.add_argument("--api_key", default=os.getenv("OPENAI_API_KEY"))
    parser.add_argument("--api_key", default="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")
